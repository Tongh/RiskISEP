...
import Model.Missions.MissionTroisRegionModel;
import View.MissionView;

public class MissionTroisRegionController extends MissionController{

	public MissionTroisRegionController(JoueurController player) {
		super(new MissionTroisRegionModel(player), new MissionView());
	}
